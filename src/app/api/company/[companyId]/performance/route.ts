...
import getCompanyStats from "@/actions/company/getCompanyStats";
...
/*
 * Should return :
 * - number of reservation with evolution % (per day, week, month, year)
 * - total price with evolution % (per day, week, month, year)
 */
